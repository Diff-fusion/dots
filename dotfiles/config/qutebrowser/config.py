...
## Type: FuzzyUrl
c.url.default_page = (
    "https://www.startpage.com/do/mypage.pl?prf=cda60f786beaf5b4427b8555b6a98ccc"
)
...
## Type: Dict
c.url.searchengines = {
    "DEFAULT": "https://www.startpage.com/do/search?op=tun1&hmb=1&prf=cda60f786beaf5b4427b8555b6a98ccc&cat=web&cmd=process_search&language=deutsch&engine0=v1all&abp=-1&t=night&nj=0&suggestOn=1&query={}",
...
## Custom bindings
#config.bind(",yv", 'hint links spawn mpv --ytdl-format="bestvideo[height<=1000][vcodec!=vp9]+bestaudio/best" {hint-url}')
#config.bind(",ya", "hint links spawn i3-msg 'workspace 10; exec termite -e \"mpv --ytdl-format=bestaudio {hint-url}\"; workspace 1'")
config.bind(",ya", "hint links spawn /home/felix/.scripts/mpvctl add-audio {hint-url}")
config.bind(",yA", "hint --rapid links spawn /home/felix/.scripts/mpvctl add-audio {hint-url}")
config.bind(",yv", "hint links spawn /home/felix/.scripts/mpvctl add-video {hint-url}")
config.bind("M", "set-cmd-text -s :spawn buku -a {url:pretty} ")
